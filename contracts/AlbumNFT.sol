    ...
    contract AlbumNFT is ERC721, Ownable, ERC721Enumerable {
      ...
      string public baseURI = "ipfs://QmZrLhfG9TKdzaJWV95WokNX1EAa3hyiTgXz5nfiptNNKz/"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT
      ...
      event AlbumMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("AlbumNFT", "EP") {}
      ...
      function mintAlbum(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit AlbumMinted(id, msg.sender);
          }
        }
      }
    
      function presaleAlbum(uint256 numberOfTokens) external payable {
