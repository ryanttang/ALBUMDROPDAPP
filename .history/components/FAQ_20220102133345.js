...
export default function MyApp() {
  ...
  return (
    <div id="faq">
      <div className="flex flex-col items-center h-screen justify-center sm:px-0 px-6 z-20 pb-32">
        ...
        <div className="lg:w-1/2 md:w-8/12 sm:w-9/12 w-full">
          <div className="bg-white shadow rounded p-8">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="font-bold font-mono uppercase text-lg leading-none text-gray-800">
                  What is an NFT?
                </h2>
              </div>
              <button
          ...
          <div className="bg-white shadow rounded p-8 mt-8">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="font-bold font-mono uppercase text-lg leading-none text-gray-800">
                  How many NFTs can I buy at once?
                </h2>
              </div>
              <button
                onClick={() => {
